...
class HomeFragmentProfileSettings : BaseFragment(), ProfileContract.ProfileView {
    ...
    companion object {
        ...
        fun newInstance(): HomeFragmentProfileSettings {

            val fragment = HomeFragmentProfileSettings()
    ...
    override fun getContentView(): Int {
        ...
        return R.layout.fragment_home_profile_settings
